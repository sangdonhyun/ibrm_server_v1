...
class SocketSender():
    ...
    def shell_detail(self,db_name,shell_name,shell_path):
        ...
        data['ARG']['shell_path'] = shell_path
        print '-'*30
        print data
        print '-' * 30
    ...
    def ss_socket_send(self,cmd="AGENT_HEALTH_CHECK"):
        data = {}
        data['FLETA_PASS'] = 'kes2719!'
        data['CMD'] = cmd
        data['ARG'] = {}
    ...
    def ag_health_check(self,cmd="AGENT_HEALTH_CHECK"):
